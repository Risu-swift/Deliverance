...
namespace IndieMarc.Platformer
{
    ...
    public class CarryItem : MonoBehaviour
    {
        ...
        private PlatformerCharacter bearer;
        ...
        private PlatformerCharacter last_bearer;
        ...
        private void UpdatePosition()
        {
            ...
            if (bearer)
            {
                PlatformerCharacter player = bearer.GetComponent<PlatformerCharacter>();
                Vector3 motion = player.GetMove();
                if (bearer.GetComponent<PlatformerCharacter>())
                {
        ...
        {
            PlatformerCharacter player = taker.GetComponent<PlatformerCharacter>();
        ...
        public void Take(PlatformerCharacter bearer)
        {
            this.bearer = bearer;
            last_bearer = bearer;
        ...
        public void Destroy()
        {
            if (bearer && bearer.GetComponent<PlatformerCharacter>())
            {
                bearer.GetComponent<PlatformerCharacter>().DropItem();
            }
            destroyed = true;
        ...
        public PlatformerCharacter GetBearer()
        {
            return this.bearer;
        }
