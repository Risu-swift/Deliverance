...
namespace IndieMarc.Platformer
{
    ...
    public class PlatformerCharacter : MonoBehaviour
    {
        ...
        [Inject]
        public void Construct(GameManager _gameManager, PlatformerCamera _platformCamera)
        {
            gameManager = _gameManager;

            _platformCamera.target = gameObject;
        }
        ...
        {
            can_hide &= collision.gameObject.GetComponent<HideTrigger>() == null;
        }
