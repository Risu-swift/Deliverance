namespace EasyLayoutNS
{
	...
	public class EasyLayout : LayoutGroup, INotifyPropertyChanged
	{
		...
		[SerializeField]
		EasyLayoutFlexSettings flexSettings;
		...
		[SerializeField]
		EasyLayoutStaggeredSettings staggeredSettings;
		...
		public Vector2 InternalSize
		{
			get
			{
				...
				return new Vector2(
					size.x - MarginHorizontal - PaddingInner.Horizontal,
					size.y - MarginVertical - PaddingInner.Vertical);
			}
		}
		...
		public float MainAxisSize
		{
			...
			{
				return IsHorizontal
					? rectTransform.rect.width - MarginHorizontal
					: rectTransform.rect.height - MarginVertical;
			}
		}
		...
		List<LayoutElementInfo> elements = new List<LayoutElementInfo>();

		Stack<LayoutElementInfo> elementsCache = new Stack<LayoutElementInfo>();
		...
		protected override void Start()
		{
			...
			StaggeredSettings = staggeredSettings;
		}
		...
		protected LayoutElementInfo CreateElement(RectTransform elem)
		{
			...
			var active = SkipInactive ? true : elem.gameObject.activeInHierarchy;
