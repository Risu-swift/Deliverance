namespace EasyLayoutNS
{
	...
	public class EasyLayoutCompact : EasyLayoutCompactOrGrid
	{
		...
		protected override void Group(List<LayoutElementInfo> elements)
		{
			...
			{
				GroupHorizontal(elements, ElementsGroup);
			}
			else
			{
				GroupVertical(elements, ElementsGroup);
			}
		...
		void GroupHorizontal(List<LayoutElementInfo> elements, List<List<LayoutElementInfo>> resultedGroup)
		{
		...
		void GroupVertical(List<LayoutElementInfo> elements, List<List<LayoutElementInfo>> group)
		{
			var base_length = Layout.MainAxisSize;
			var length = base_length;
